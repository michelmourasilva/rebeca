...
BEGIN
        ...
        where projeto.no_projeto = v_projeto and configuracao.no_modulo = v_modulo;
        ...
        if p_id_filtro is not null then
          ...
          select v_nome_ref_cursor || ' WHERE ' || filtro.NO_ATRIBUTO || tipofiltro.DS_TIPO_FILTRO into v_nome_ref_cursor
          ...
          where filtro.id_configuracao_servico = v_id_configuracao and filtro.id_filtro_servico = v_id_filtro;
        end if;
		-- Abre um cursor
